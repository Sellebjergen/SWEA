...
import hotciv.standard.WorldLayoutStrategies.AdapterWorldLayoutImpl;
import hotciv.standard.WorldLayoutStrategies.AlphaWorldLayoutImpl;

public class AdapterWorldLayoutHotCivFactory implements HotcivFactory {
  ...
  public WorldLayoutStrategy createWorldLayoutStrategy() {
    return new AdapterWorldLayoutImpl();
  }
